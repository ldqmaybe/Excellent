...
class NetworkUtils private constructor() {
    ...
    companion object {
        ...
        private val activeNetworkInfo: NetworkInfo?
            get() = (MyApp.context.getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager).activeNetworkInfo
        ...
        var dataEnabled: Boolean
            get() {
                try {
                    val tm =
                        MyApp.context.getSystemService(Context.TELEPHONY_SERVICE) as TelephonyManager
        ...
        var wifiEnabled: Boolean
            get() {
                ...
                val wifiManager =
                    MyApp.context.getSystemService(Context.WIFI_SERVICE) as WifiManager
